...
#[doc = " used to transform the data, for instance to encrypt it.  If the buffers are"]
#[doc = " changed in size, then the MQTTAsync_malloc and MQTTAsync_free calls must be"]
#[doc = " used to reallocate them."]
...
#[doc = " used to transform the data, for instance to decrypt it.  If the buffers are"]
#[doc = " changed in size, then the MQTTAsync_malloc and MQTTAsync_free calls must be"]
#[doc = " used to reallocate them."]
...
pub struct MQTTAsync_message {
    ...
    #[doc = " to it will serve no purpose."]
...
pub struct MQTTAsync_connectOptions {
    ...
    pub struct_id: [::std::os::raw::c_char; 4usize],
    #[doc = " The version number of this structure.  Must be 0, 1, 2, 3 4 5 6 or 7."]
